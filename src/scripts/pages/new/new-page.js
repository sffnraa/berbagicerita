      ...
      <section class="container-form">
        <div class="new-form__container">
          <form id="new-form" class="new-form">
            ...
            <div class="form-control">
              <label for="documentations-input" class="new-form__documentations__title">Lampirkan Gambar</label>
              <div id="documentations-more-info">Mari lampirkan gambar agar ceritamu makin seru.</div>

              <div class="new-form__documentations__container">
                <div class="new-form__documentations__buttons">
                  <button id="documentations-input-button" class="btn-outline" type="button">Cari Gambar</button>
                  <input
                ...
                <div class="new-form__camera__tools">
                  <select id="camera-select"></select>
                   <div class="new-form__camera__tools_buttons">
                    <button id="camera-take-button" class="btn-take" type="button">
                      Ambil Gambar
                    </button>
                  </div>
                </div>
            ...
            <div class="form-buttons">
              <span id="submit-button-container">
                <button class="btn-add" type="submit">Tambahkan Cerita</button>
              </span>
              <a class="btn-back" href="#/">Batal</a>
            </div>
          </form>
        </div>
      </section>
